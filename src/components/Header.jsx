...
function Header({ score, seconds }) {
  return (
    <header className="h-[90px] bg-white flex justify-between px-4 items-center">
      ...
      {/* LOGO */}
      <div className="title text-4xl font-mono hover:cursor-default">
        Flexbox<span className="text-red-500"> Sensei</span>
      </div>

      {/* TIME DIV */}
      <div className="flex flex-col justify-center items-center">
        <div className="bg-white py-4 rounded-full w-[70px] shadow-xl text-center">
          {seconds}
        </div>
