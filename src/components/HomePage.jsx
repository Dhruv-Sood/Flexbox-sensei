...
function HomePage({ startGame, setScore, setSeconds ,setIndex }) {
      ...
      {showRules ? (
        <div className="h-remaining grid place-content-center">
          <div className="h-[600px] w-[800px] bg-black bg-opacity-80 text-white font-mono tracking-[1px] p-4">
            <div className="flex justify-between font-bold text-3xl h-[40px]">
              <span>RULES</span>
              <span onClick={toggleRules} className="hover:cursor-pointer">
                X
              </span>
            </div>
        ...
        <div className="h-remaining  flex flex-col w-screen justify-center items-center gap-4">
          <div className="flex gap-4">
            <div className="homeBtn" onClick={() => startGame()}>
              START GAME
            </div>
            <a
              className="text"
              ...
              target="_blank"
            >
              <div className="homeBtn">LEARN FLEXBOX</div>
            </a>
          </div>
          <div className="flex">
            <div className="homeBtn" onClick={toggleRules}>
              RULES
            </div>
          </div>
        </div>
